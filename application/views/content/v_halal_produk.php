        ...
        <div class="row g-4 py-5">
            <?php foreach ($halalproduk as $hp) { ?>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <a href="<?= @$_GET['lang'] == 'eng' ? base_url() . 'halalproduk/detail_halalproduk/' . $hp->slug . '?lang=eng' : base_url() . 'halalproduk/detail_halalproduk/' . $hp->slug ?>">
                        <div class="box-shopping pb-4">
                            <div class="img">
                                <img src="https://maskargo.digitalindo.co.id/upload/halal_produk/<?= $hp->image; ?>" class="img-fluid" alt="">
                            </div>
                            <div class="content p-2">
                                <div class="title">
                                    <?php if (strlen($hp->nama) > 100) { ?>
                                        <p><?= substr($hp->nama, 0, 100); ?>...</p>
                                    <?php } else { ?>
                                        <p><?= substr($hp->nama, 0, 100); ?></p>
                                    <?php } ?>
                                </div>
