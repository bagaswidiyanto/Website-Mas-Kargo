                ...
                <ul class="nav nav-tabs border-0" id="myTab">
                    ...
                    <li class="nav-item">
                        <a href="#tab-<?= $l->id ?>" class="nav-link"
                            title="<?= @$_GET['lang'] == 'eng' ? $l->nama_sub_eng : $l->nama_sub ?>"
                            data-bs-toggle="tab"><?= @$_GET['lang'] == 'eng' ? $l->nama_sub_eng : $l->nama_sub ?></a>
                    </li>
                    <?php } ?>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4">
                                <div class="img-service">
                                    <a href="https://maskargo.digitalindo.co.id/upload/gallery/<?= $gs->image; ?>"
                                        data-gallery="portfolioGallery" class="portfolio-lightbox"
                                        title="<?= $g->nama; ?>">
                                        <img src="https://maskargo.digitalindo.co.id/upload/gallery/<?= $gs->image; ?>"
                                            title="<?= $gs->nama; ?>" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                            <?php } ?>
