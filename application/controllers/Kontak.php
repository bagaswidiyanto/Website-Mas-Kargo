...
class Kontak extends MY_Controller
{
  public function index()
  {
    ...
    $this->data['slider'] = $this->db->get_where('tbl_slider', array('posisi' => 'Kontak', 'aktif' => 'Y'))->row();

    $this->data['vendor'] = $this->db->get('tbl_vendor')->row();

    $this->middle = 'content/v_contact_us'; // untuk loading page homenya. rubah pada bagian ini untuk halaman lainnya.
    $this->layout();
  }
